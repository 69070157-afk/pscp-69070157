...
```text
 โจทย์ ให้เราหาว่า ค่าอุณหภูมิที่ได้รับในหน่วยที่ได้รับ ถ้าจะแปลงเป็นหน่วยที่ต้องการค่านั้นจะมีค่าเท่าได

input: รับค่าที่กําหนด

output: ค่าอุณหภูมิที่แปลงหน่วยแล้ว
```
...
```text
1:รับค่าที่กําหนด
2:แปลงค่าของอุณหภูมิให้อยู่ในหน่วย c 
3:ตรวจว่าค่าที่ต้องการใช่หน่วย k หรือไม่ถ้าใช่ให้แปลงหน่วยแล้วเก็บไว้ใน P
4:ตรวจว่าค่าที่ต้องการใช่หน่วย f หรือไม่ถ้าใช่ให้แปลงหน่วยแล้วเก็บไว้ใน P
5:ตรวจว่าค่าที่ต้องการใช่หน่วย r หรือไม่ถ้าใช่ให้แปลงหน่วยแล้วเก็บไว้ใน P
6;ตรวจว่าค่าที่ต้องการใช่หน่วย c หรือไม่ถ้าใช่ให้ค่าเก็บไว้ใน P
7:แสดงค่าของ P
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก มีการปรับเล็กน้อยคือหากหน่วยที่ต้องการเหมือนกับหน่วยที่ได้รับ ให้แสดงค่านั้นๆโดยไม่ต้องแปลง
```
...
```text
case หน่วยที่ได้รับตรงกับหน่วยที่ต้องการ
```
