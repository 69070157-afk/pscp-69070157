...
```text
โจทย์ให้รับเดือนและวันมาแล้วคํานวนว่าเป็นฤดูอะไร

input: เดือน 1 ค่า และวัน 1 ค่า

output: ฤดูของเดือนวันนั้นๆ โดยช่วงเปลี่ยนฤดูคือวันที่21ของเดือนที่3ของฤดู

constraints: วันที่ฤดูจะถูกจะถูกเปลี่ยนเป็นช่วงเวลาเฉพาะจึงต้องมีการหาว่าเดือนตรงไหมถ้าตรงแล้ววันตรงไหม
```
...
```text
1: รับค่า เดือน และ วัน ตามลําดับ
2: ตรวจว่า เดือนหาร 3 ลงตัวไหม หากหารลงตัวตรวจเพิ่มว่า วัน มากกว่าหรือเท่ากับ 21 ไหม
3:ถ้า ใช่ ให้ใช้ชุดคําสั้งพิเศษ ถ้าไม่ให้ใช้ชุดคําสัง ปกติ
```
...
```text
case ถึงเดือนเปลี่ยนฤดูแต่วันยังไม่ใช่
```
