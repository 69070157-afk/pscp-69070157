...
```text
โจทให้เราเช็คว่า เมื่อเราส่งของขวันให้ k คนถัดไปวนจนถึง 1 หรือ คนที่ t มีจํานวนคนที่ได้ถือของขวันกี่ครั้ง
input: รับค่า n k t

output:แสดงค่าของคนที่ได้ถือของขวัน
```
...
```text
1:รับค่า  n k t 
2:กําหนดค่า สถานะของขวันเป็น true และ number เป็น 1
3:วนลูปจนกว่า สถานะจะเป็น false
4:ถ้า number เท่ากับ t เปลี่ยนสถานะ เป็น false
5:number += k ถ้าเกิน n ลูป number -= n จนกว่าจะน้อยกว่าn
6:i += 1
7:ถ้า number เป็น false ทําลายลูปแล้วแสดงi
```
