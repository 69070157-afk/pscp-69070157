...
| OJ submission ID, if submitted | 599485 |
| OJ status | Pass |
...
```text
ผมให้ ai ดูว่ามี bug  อะไรใน code ของผมบ้าง
```
...
```text
   ai แนะนําให้ผมใช้ math.ceil แทนการปัดเศษที่ผมใช้อยู่ เพราะว่า มันจะผิดพลาดได้ถ้ามันเป็นทศนิยม
```
...
```text
ผมได้ลอง เปลี่ยนวิธีปัดเศษของผมและส่งเข้า ij และผ่าน
```
...
```text
ต้องหัดใช้ import math ให้มากกว่านี้มันสดวกกว่าเยอะ
```
