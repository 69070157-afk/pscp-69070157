...
```text
โจทย์ ให้เราหาว่าถ้ามี lnk จํานวนใดๆปล่อยมาจากจุด 0,0 จะไปถึงบ้านของผู้คนในเวลาเท่าไหร่ โดย lnk มีการกระจายเป็นรูปแบบวงกลม

input: รับค่าของ lnk ที่ปล่อยออกมา และจํานวนของ บ้านที่ต้องการข้อมูล และรับที่อยู่ของบ้านแต่ละหลัง

output: วินาทีที่บ้านตํ่าแหน่งที่ i โดน lnk โดยถ้าเป็นทศนิยมให้ปัดขึ้น
```
...
```text
เราจะดูว่าตอนที่lnkมาถึงบ้านปริมาตรของมันควรเป็นเท่าได แล้วเอาที่ได้ไปหารกับ ปริมาณของ lnk ที่ปล่อยออกมาโดยปัดเศษขึ้น ทําซํ้าจนครบจํานวนบ้านทั้งหมด และ แสดงผลออกมาตามลําดับ
```
...
```text
วิธีสุดท้ายของฉันเกือบเหมือนกับแผนแรก ตอนแรกผมจะใช้วิธีปัดเศษแบบ ลบออกด้วย1นําไปหารแบบปัดเศษทิ้งแล้วบวกด้วย1แต่มันไม่ผ่านเลยต้องใช้ math.ceil แทน
```
