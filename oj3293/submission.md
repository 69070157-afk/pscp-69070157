...
```text
โจทย์ ให้้เรารับstrมา5ตัวโดยให้เราprintออกมา7บรรทัดโดยในบรรทัดที่ 1 , 7 จะมีตัว*อยู่จํานวน Len()ของตัวที่มากที่สุดโดยตัดช่องว่างหลังสุดออก  ส่วนบรรทัดที่เหลือต้องมี * ปิดท้ายและมีช่องว่างขั้นและตัว * ต้องอยู่ตรงกัน

input: strจํานวน5บรรทัด

output:  7บรรทัดโดยในบรรทัดที่ 1 , 7 จะมีตัว*อยู่จํานวน Len()ของตัวที่มากที่สุดโดยตัดช่องว่างหลังสุดออก ส่วนบรรทัดที่เหลือต้องมี * ปิดท้ายและมีช่องว่างขั้นและตัว * ต้องอยู่ตรงกัน
```
...
```text
1:รับค่าstrทั้งหมดโดยตัดช่องว่างออก
2:หาlen()ที่มากที่สุด
3:เติมช่องว่างให้กับทุกstrให้มี len()เท่ากับตัวที่มากที่สุด
4:print()โดยบรรทัดแรกและท้ายมี*เท่ากับค่าที่มากสุด+=4
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ผมใช้.rstrip()ในการตัดช่องว่างหลังสุดออก
```
