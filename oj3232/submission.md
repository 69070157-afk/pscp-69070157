...
```text
โจทย์ ให้เราหาจํานวนครั้งในการกระโดดที่น้อยที่สุดเพื่อให้กบไปถึงเป้าหมายเมื่อเป้าหมายเป็น yและระยะกระโดดเป็นx ที่จะลดลง2ทุกครั้งที่กระโดด
input:รับค่า x,y

output:จํานวนครั้งที่กระโดด ถ้าไม่มีวันไปถึงความจริงแสดง-1
...
```text
1:รับค่าที่กําหนด
2:วนลูปจนกว่า way จะสูงกว่า y
3:เพิ่มค่า i ขึ้น 1 
4:กําหนดระยะกระโดด เท่ากับ x-((i-1)*2)
5:เพิ่มระยะกระโดดเข้า way
6:เช็คว่าถ้า ระยะกระโดด ตํ่ากว่าหรือเท่ากับ0 ให้ i = -1 ทําลายลูป
7: แสดงค่า i
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ใช้ while ในการสร้างลูป และ if and break ในการเช็คกรณีไม่มีวันไปถึงความจริง
```
