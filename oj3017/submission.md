...
```text
โจทย์ให้เรารับราคารวมมาแล้วให้เราหาค่าบริการและ  "ภาษี" แล้ว out ราคาจริงๆที่ลูกค้าต้องจ่าย

input: ราคารวมแบบดิบ 1 ค่า

output: ราคาที่ต้องจ่ายแบบรวมค่าบริการและภาษีแล้ว

constraints: เนื่องจากค่าบริการ มีขั้นตํ่าและสูงสุดอยู่ จึงต้องมีกรณีแยกสําหรับแต่ละกรณีด้วย
```
...
```text
1:รับราคารวมแบบดิบ
2:หาว่าค่าบริการมีค่าเท่าใด
3:ตรวจว่าค่าบริการเข้าข่ายตํ่ากว่าขั้นตํ่าหรือเกินสูงสุดไหม แล้วดําเนินตามแต่ละกรณีที่เข้าข่าย
4:หาภาษี
5:นําราคารวมแบบดิบ ค่าบริการ และ ภาษี มารวมเป็นราคาจริง
6:พิมพ์ราคาจริง
```
...
```text
case ค่าบริการตํ่ากว่าขั้นตํ่า
```
