...
```text
โจทย์ให้เรารับขัอความมา  1  ข้อความแล้วแปลงมันให้ตัวอักษรกลับด้านโดยที่ทั้งหมดที่ออกมาต้องเป็นตัวพิมเล็ก

input : ข้อความที่มีความยาว 5 อักขระ

output:ข้อความตัวอักษรภาษาอังกฤษแบบกลับด้านเป็นตัวพิมพ์เล็กเท่านั้น

Constraints:โจทย์บอกว่า output ต้องเป็นตัวเล็กแสดงว่า input ต้องมีตัวใหญ่ด้วยต้องหาทางแปลงเป็นตัวเล็ก
```
...
```text
1 : รับข้อความ 
2 : แปลงเป็นตัวพิมเล็กด้วย .lower()
3 : แปลงกลับด้านด้วย [::-1]
4 : พิมข้อความที่แปลงแล้ว
```
...
```text
เหมือนแผนแรก .lower() สามารถกําจัดตัวพิมใหญ่ได้ และ [::-1] สามารถกลับด้านข้อความได้ดังหวัง
```
...
```text
ดูว่าจะสามารถกําจัดตัวใหญ่ได้ไหม
```
