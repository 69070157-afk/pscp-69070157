...
```text
โจทย์ ให้เราเช็คว่าช่วงเวลาที่เราต้องการไป จะมีร้านเปิดอยู่เท่าไหร่
input: รับจํานวนร้าน และช่วงเวลาที่เราจะเช็ค ต่อไปคือเวลาเปิดปิดของร้านเป็นนาที และสุดท้ายคือช่วงเวลาทั้งหมดที่เราจะเช็ค

output: จํานวนร้านที่เปิดในแต่ละช่วงเวลาเรียงตามเวลาที่ต้องการเช็ค เช่น 666 667 669 แสดง จํานวนร้านที่เปิด ณ 666 , จํานวนยร้านที่เปิด 667 , จํานวนร้านที่เปิด ณ 669 
```
...
```text
1:รับค่า จํานวนร้าน และ จํานวนเวลาที่ต้องเช็ค
2:เก็บค่าของเวลาเปิดของร้านไว้ใน start ตํ่าแหน่งที่ n-1 ; เมื่อ n เป็นตําแหน่งของร้านที่รับข้อมูลเข้า
3:ทําแบบข้อก่อนหน้า แต่เป็นเวลา ปิด และ เป็นตัวแปร stop
4:ทําซั้าจนครบจํานวนร้าน
5:รับค่าของ ช่วงเวลาที่ต้องการเช็ค
6:เริ่มเช็คโดยดูว่าเวลาที่ต้องเช็คนี่อยู่ในช่วงเวลาเวลาเปิดของร้านที่ n ไหม ทำซํ้าจนครบจํานวนร้าน
7:หลังจากเช็คครบทุกร้านแล้ว ให้แสดงค่าที่ได้โดยไม่ขึ้นบรรทัดใหม่
8:ทําซํ้าจนครบจํานวนเวลาที่ต้องการเช็ค
```
...
```text
case ไม่มีร้านเปิดเลยในเวลาที่ต้องเช็ค  
```
