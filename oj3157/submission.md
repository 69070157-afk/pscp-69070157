...
```text
โจทน์ จากอินพุตที่ได้รับเข้ามา ถ้าเพิ่มลดคะแนนตามเงื่อนไขคะแนนสุดท้ายจะได้เท่าไหร่
input: รับค่า n และรับค่า(+,-)อีก n ครั้ง

output: แสดงคะแนนสุดท้าย
```
...
```text
1:ทํา for loop ตามค่าที่รับเข้ามา
2:ดูว่าค่าที่รับเข้ามา ตรงตามเงื้อนไขใดแล้วทําการบวกลบตามเงื่อนไขนั้นๆ
3:แสดงค่าสุดท้ายหลังจากทําจนครบลูป
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ใช้ for loop เพื่อรับค่าทั้งหมดแล้วใช้ if else เพื่อสร้างเงื้อนไขในการ บวกลบ คะแนน
```
