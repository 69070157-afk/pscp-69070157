...
```text
โจทย์ ให้เรารับตัวย่อของไพ่เข้ามา แล้วให้เราบอชื่อจริงของไพ่ใบนั้นๆ
input: รับชื่อย่อของไพ่

output: แสดงชื่อจริงของไพ่ใบนั้นๆ
```
...
```text
1:รับชื่อย่อของไพ่แล้วแยกเป็นชื่อหน้าและหลัง
2:เช็คว่าชื่อย่อหน้าตรงกับอะไรแล้วเก็บค่าชื่อจริงออกมา
3:เช็คว่าชื่อย่อหลังตรงกับอะไรแล้วเก็บค่าชื่อจริงออกมา
4:นําชื่อย่อมาประกอบกันเชื่อมด้วย of พร้อมแสดงผล
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ผมใช้ if else elif ในการเช็คว่าชื่อย่อนี้ชื่อจริงมันคือไร
```
