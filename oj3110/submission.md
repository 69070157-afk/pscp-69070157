...
```text
input: เส้นทางและนํ้าหนักของสินค้า

output: แสดงค่าขนส่งของรายการที่รับเข้ามา
```
...
```text
1:รับค่าที่กําหนด
2:เช็คว่ารายการนี้เป็นเส้นทางใดและใช้สูตรของเส้นทางนั้นๆในการสร้างค่าขนส่ง
3:แสดงค่าขนส่ง
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ผมใช้ if elif elseในการเช็คว่าเราต้องใช้สูตรใดในการหาค่าเดินทาง
```
