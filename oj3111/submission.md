...
```text
โจทย์ ให้ดูว่ารายการที่ได้รับ จะได้รับส่วนลดเท่าไหร่แล้วนําไปคํานวนเป็นค่าใช้จ่ายของรายการนี้
input: สถานะสมาชิก จํานวนรายการ และราคาของรายการ

output: จํานวนเงินทั้งหมดที่ต้องจ่าย หลังจากคํานวนส่วนลดแล้ว
```
...
```text
1:รับค่าสมาชิกและจํานวนรายการ
2:หาราคารวมของรายการ
3:ตรวจว่ารายการนี้เข้าเกณส่วนลดใดบ้าง
4:คํานวนราคาของรายการนี้
5:แสดงผล
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ผมใช้ for ลูปในการรับราคาของรายการ และ ใช่ การบวกด้วย 0.001 เพื่อให้การปัดเศษเป็นการปัดแบบ  (ปัดเศษมาตรฐาน – round half up) เพราะปกติมันจะปัดเศษจาก 6 not 5
```
...
```text
case ไม่เป็นสมาชิก แต่ราคารวมเกิน 500
```
