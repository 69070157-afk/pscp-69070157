...
```text
โจทร์ ให้เรารับค่าเริ่มต้น และค่าสุดท้ายหน้าที่ของเราคือหาว่าระหว่างค่าสองค่านี้(รวมตัวเองด้วย) มีจํานวนเฉพาะเท่าไหร่และมีอะไรบ้าง
input: รับค่าเริ่มต้นและค่าจบ

output: จํานวนเฉพาะทั้งหมดที่อยู่ระหว่างค่าสองค่า และ จํานวนของจํานวนเฉพาะที่อยู่ระหว่างค่า
```
...
```text
1:รับค่าต้นและค่าจบ
2:ลูปเช็คค่าทั้งหมดที่เข้าเกณ ค่าพื้นฐานของสถานะจํานวนเฉพาะเป็นจริง
3:ถ้าค่าที่เช็คอยู่เป็น 1 หรือหารได้ด้วยสองกําหนดให้สถานะ เป็นเท็จ
4:ถ้าค่าที่เช็คไม่เข้าเกณก่อนหน้า ให้เริ่มลูป โดยเช็คค่าตั้งแต่3จนถึงค่าที่เช็คว่า ค่าที่เช็คสามารถหารด้วยค่าใดๆ
ตั้งแต่ สาม จนถึงตัวมันเองหารด้วยสองได้หรือไม่ ถ้าได้ สถานะเป็น เท็จ
5:ถ้าสถานะเป็นจริงหรือเท่ากับสอง แสดงค่าและจบด้วยช่องว่าง
6:แสดงค่าของจํานวนเฉพาะทั้งหมด
```
...
```text
วิธีสุดท้ายของฉันมีเค้าโครงเหมือนแผนแรก ผมใช้การเช็ค จากทุกตัวจาก 3จนถึงค่าที่เช็ค เป็นเช็คค่าเว้นค่าแทน และตอนแสดงผลใช้การบันทึกเข้าเซตแทนพิมสดๆออกมาแทน
```
