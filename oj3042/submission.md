...
```text
โจทให้รับ ตัวเลขมาหนึ่งค่าแล้วบอกว่า ภายในตัวเลขนั้นมีเลขอะไรหารด้วย 10 ได้บ้าง
input: ตัวเลข 1 ค่า

output: ตัวเลขที่ตํ่ากว่า input ที่สามารถหาร10ได้

constraints: ผมprintเป็นเซตแบบไม่มี [] กะ , ไม่เป็นต้องไปศึกษาาเพิ่ม
```
...
```text
1:รับค่า n
2:นํา n //10 แล้ว*10 เพื่อกําจัด เศษเกิน
3:ใช้ while โดย ให้ print (n) แล้ว n -= 10 ทําซั้าจนกว่าจะ 0
```
...
```text
เปลี่ยนไปอย่างสิ้นเชิงเพราะoutputผมผิด ที่ผมทํามันเป็นแบบ ออกมาทีละบรรทัด แต่ที่ต้องการคือออกมาในบรรทัดเดียวแต่แบ่งออกเป็นตัวที่หารได้แล้วเว้นด้วยช่องว่าง แล้วตัวต่อไปจนจบ ผมจึงเริ่มทําใหม่ พออ่านทบทวนโจทย์ใหม่รู้สึกว่า range() น่าจะใช้ได้ดี เพราะเป็นการสร้างเซตตัวเลข ที่เราสามารถกําหนด จุดเริ่ม จุดจบ และมันจะเปลี่ยนที่ละเท่าไหร่ได้ เลยไม่จําเป็นต้องหาทางยัดoutputเข้าเซต
```
