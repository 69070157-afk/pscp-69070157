...
```text
โจทย์ ให้เรารับข้อความมาแล้วดูว่าภายในข้อความมีสระ a e i o u ไหมถ้ามีให้บอกจํานวนมาตามลําดับ ถ้าลําดับไหนไม่มีไม่ต้องบอกโดย ตัวพิมใหญ่และเล็กถือเป็นตัวเดียวกัน

input: รับข้อความมา

output: แสดงสระที่มีแล้วบอกว่ามีเท่าไหร่
```
...
```text
1:รับข้อความแล้วแปลงเป็นตัวเล็กทั้งหมด
2:หาว่าภายในข้อความมี a e i o u ไหมและเท่าไหร่ตามลําดับ
3:ถ้ามีแสดงว่ามี อะไรบ้าง และ เท่าไหร่ ตามลําดับ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ผมใช้ .lower() เพื่อกําจัดตัวใหญ่ออกแล้วใช้ .count() เพื่อหาว่ามีอะไรเท่าไหร่ จากนั้นค่อยแสดงโดยใช่ if ถ้ามีให้แสดง
```
