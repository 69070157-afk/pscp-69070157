...
```text
โจทย์ให้รับตัวเลขมาสองจํานวนโดยที่อันแรกคือค่ารวมอันสองคือค่าสูงสุดแล้วให้เราหาว่ามีโอกาศที่ค่าสูงสุดจะต่างจากค่าตํ่าสุดเกิน 2 ไหม

input: รับค่ารวม กับค่าสูงสุดมา

output: แสดงว่า Surprising ในกรณีที่ ค่าสูงสุดเกินจากค่าตํ่าสุด 2 แต้มขึ้นไป ถ้าไม่ แสดง Not surprising

Constraints: ถ้าเราใช้วิธีหาค่า กลาง แบบห้วน ๆเลยมีโอกาศที่ค่ากลางจะสูงกว่าค่าสูงสุดได้ซึ้งไม่ควรจึงต้องจํากัดให้เมื่อเริ่มเช็คต้องเริ่มที่ค่าสูงสุดแทนไม่ใช่ 10 และ ความง้าวและโง่ของตัวผู้เขียน เค้าบอกอยู่ว่าเกิน 2 จะ Surprising แต่จะเขียน => 2 ทําไม
```
...
```text
1:รับค่าสูงสุดและค่ารวม
2:นําค่ารวม ลบ ค่าสูงสุดเพื่อให้ได้ค่ากลางบวกกับค่าตํ่า
3:นําเข้าลูบเช็คโดยเริ่มจากค่าสูงสุด แล้วลดที่ละ1 จนกว่าจะ 0 
4:ถ้า ค่ากลางบวกตํ่าลบกับค่าเช็คแล้วได้ มากว่าเท่ากับ 0 ค่านั้นคือค่ากลางและออกจาก ลูบ
5:นําค่ากลางลบกับ ค่ารวมระหว่างกลาง และ ตํ่า ค่าที่ได้คือตํ่า
6:เช็คว่าค่าสูงกับตํ่าห่างกันเกินหรือเท่ากับ 2 ไหมถ้าใช่ แสดง Surprisingนอกนั้น Not Surprising
```
...
```text
วิธีสุดท้ายของฉันเกือบเหมือนกับแผนแรก แค่เปลี่ยน =>2 เป็น >2
```
...
```text
case พิเศษ แต่ควร Not surprising
```
