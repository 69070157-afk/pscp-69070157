...
```text
โจทย์ ให้เราดูว่าเราสามารถสร้างสพานด้วนจํานวนอิธที่มีได้ไหมถ้าได้ให้บอกจํานวนอิธเล็กที่ใช้โดยที่ใช้อิธใหญ่ให้มากที่สุด ถ้าไม่บอก -1 

inpuut: รับค่าจํานวนอิธขนาดใหญ่และเล็กที่มี และรับค่าความยาวของสพาน

output: แสดงค่าของอิธเล็กที่ใช้ถ้าสร้างไม่ได้ให้แสดงค่า -1
...
```text
1:รับค่าที่กําหนด
2:หาว่าระหว่าง จํานวนอิธใหญ่ที่ใช้ได้มากสุดในการสร้างกับที่มีอันไหนน้อยกว่ากัน
3:หาค่าของอิธเล็กที่ต้องใช้
4:หาว่าอิธเล็กที่มี มีพอสําหรับการสร้างหรือไม่
5:ถ้าใช่ แสดงจํานวนอิธเล็กที่ใช้สร้าง
6:นอกจากนั้น แดสง -1
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ผมใช้ min() ในการหาค่าอิธใหญ่ที่ใช้จริงๆแล้วหาอิธเล็กโดยการนําความยาวทั้งหมดมาลบกับอิธใหญ่*5  แล้วใช้ if else ในการหาว่าเรามีอิธเล็กพอไหม
```
