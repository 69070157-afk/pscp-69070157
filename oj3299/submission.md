...
```text
โจทย์ให้เรารับขนาดของแถบและจำนวนช่องที่เราปลูกดอกไม้ในรูปแบบข้างต้น แล้วคำนวณว่าช่องสุดท้ายที่ปลูกเป็นดอกไม้ในแถบใด
input: รับ ขนาดแถบและจํานวนดอกไม้ที่ปลูก

output: หมายเลขของแถบสุดท้ายที่มีดอกไม้
```
...
```text
1:รับค่า
2:หาว่าต้องใช้กี่แถบ กรณีแถบ เท่ากับหนึ่ง ถึงจะสามารถปลูกดอกไม้ได้ หมดโดยขนาดของแปลงเท่ากับหมายเลขชั้น คือเพิ่มที่ละหนึ่ง
3:เอาแถบที่ใช้มาหารกับขนาดโดยปัดขึ้นเสมอ
4:แสดงค่าขงแถบนั้นๆ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ผมใช้ import math math.ceil()ในการรปัดเศษ
```
