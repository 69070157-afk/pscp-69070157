...
```text
โจทย์ ให้เรารับค่าของ ล็อตตอรี่ที่1กับที่เราซื้อมาแล้วเช็คว่ารางวัลที่สูงที่สุดที่เราได้คือไร

input: ล็อตตอรี่ที่1กับของเรา

output:จํานวนเงินที่ถูกรางวัล
```
...
```text
1:รับค่า
2:สร้าง dictionary เงินรางวัลจากข้อมูล ล็อตเตอรี่ที่1
3:ใส่ทุกรูปแบบที่ใส่ใน dictionary แล้วเก็บเข้าลิส
4:หาค่าที่มากสุดใน ลิส
5:แสดงค่านั้น
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ผมใช้ dictionary แทนการสร้าง if else elif 
```
...
```text
case เลขท้ายสองตัวและ อักศรตรง
```
