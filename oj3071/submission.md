...
```text
โจทย์ ให้หาว่า ระหว่าง A - B (รวม A กับ B ด้วย) มีตัวอะไรบ้างที่หารด้วย b แล้วได้เศษ r

input: รับค่าที่กําหนด

output: แสดงจํานวนของค่าระหว่าง A กับ B ที่สามารถหาร b ได้เศษ r
...
```text
1:รับค่าที่กําหนด
2:หาว่า A - r หาร b ได้เท่าไหร่
3:หาว่า B - r หาร b ได้เท่าไหร่
4:เอา ค่าที่ได้จากข้อ 3 มาลบกับ ข้อ 2 (เพราะเราต้องการแค่ค่า A - B เพราะงั้น 0 - A เลยไม่จําเป็น
5:แสดงค่าที่ได้
...
```text
วิธีสุดท้ายของฉันเปลี่ยนจากแผนแรกนิดหน่อย เนื่องจากตอนแรกผมลืมไปว่าถ้้า A อยู่ในคําตอบด้วยตอน นํา 0 - A ลบออกจาก 0 - B  เพื่อให้ได้ A - B ค่า A จะถูกลบออกไป เลยต้องใช่ if เพื่อหาว่า A อยู่ในคําตอบไหมถ้าใช่ ให้บวกกลับเข้าไป
```
