...
```text
โจทย์ให้รับสีมาแล้วนํามาผสมกันให้เกิดสีใหม่แต่ถ้าสีที่รับไม่อยู่ในแม่สีให้บอก Error

input : รับข้อความที่เป็นสีมา 2 ข้อความ

output : ข้อความ(สีใหม่ที่ผสมแล้ว , Error)

constraints : เนื่องจาก input เป็นข้อความมันจึงเป็นอะไรก็ได้ เราจึงควรตรวจแต่แรกเลยว่ามันอยู่ในแม่สีไหม
และ ตัวสีมันสามารถสลับกันได้แต่จะยังให้ผลลับเดิม ต้องพิจารณาตรงนี้ด้วย 
```
...
```text
1:อ่านค่าสีทั้งสอง
2:ดูว่าสีอยู่ในแม่สีไหมถ้าไม่ out = Error
3:ดูว่าสีตรงกันไหมถ้าใช่ out = in
4:แปลงสีเป็นเลข r = 1 b = 2 y = 3
5:จับมาบวกกัน ถ้า =3 out V =4 out O =5 out G นอกจากนั้น Error
6:out สีที่ผสมแล้ว
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ทุกอย่างเป็นไปตามแผนมีบักบ้างเล็กน้อยเนื่องจากผมใช้วิธีคัดลอกแล้ววางเพราะโค้ดส่วนใหญ่เป็นแบบเดิมแค่เปลี่ยนตัวแปลเลยมีอ๋องๆลืมเปลี่ยนบ้าง
```
